          ...
          <div className="flex items-center gap-2 sm:gap-6">
            <button className="hover:cursor-pointer"
              ...
              <svg
                ...
                aria-hidden="true"
                role="img"
                className="iconify iconify--solar dark:hidden block text-dark"
                width="32"
                height="32"
                viewBox="0 0 24 24"
              >
            ...
            <div className="hidden md:block">
              <Link
                to="#"
                className="text-base text-inherit flex items-center gap-2 border-r pr-6 text-dark hover:text-primary"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
