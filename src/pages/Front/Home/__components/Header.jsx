        ...
        <div className="container max-w-8xl mx-auto px-5 2xl:px-0 pt-32 md:pt-60 md:pb-68">
          <div className="relative text-white dark:text-dark text-center md:text-start z-10">
            ...
            <div className="flex flex-col xs:flex-row justify-center md:justify-start gap-4">
              <Link to="/contactus" className="px-6 md:px-8 py-4 border border-white dark:border-dark bg-white dark:bg-dark text-dark dark:text-white duration-300 dark:hover:text-dark hover:bg-transparent hover:text-white text-base font-semibold rounded-full hover:cursor-pointer">
                Get in touch
              </Link>
              <Link 
                to="/properties"
                className="px-6 md:px-8 py-4 border border-white dark:border-dark bg-transparent text-white dark:text-dark hover:bg-white dark:hover:bg-dark dark:hover:text-white hover:text-dark duration-300 text-base font-semibold rounded-full hover:cursor-pointer">
                View Details
              </Link>
            </div>
          </div>
          ...
          <div className="hidden md:block absolute -top-2 -right-68">
            <img
              ...
              decoding="async"
              data-nimg="1"
              src={getImageUrlFront("heroBanner.png")}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:flex gap-16 md:gap-24 sm:text-center dark:text-white text-black">
            <div className="flex flex-col sm:items-center gap-3">
              ...
              <img
                ...
                src={getIconGlobal("dark-sofa.svg")}
                style={{ color: "transparent" }}
              />
            ...
            <div className="flex flex-col sm:items-center gap-3">
              ...
              <img
                ...
                data-nimg="1"
                className="hidden dark:block"
                src={getIconGlobal("dark-tube.svg")}
                style={{ color: "transparent" }}
              />
              <p className="text-sm sm:text-base font-normal text-inherit">
                4 Restroom
            ...
            <div className="flex flex-col sm:items-center gap-3">
              ...
              <img
                ...
                data-nimg="1"
                className="hidden dark:block"
                src={getIconGlobal("dark-parking.svg")}
                style={{ color: "transparent" }}
              />
              <p className="text-sm sm:text-base font-normal text-inherit">
                Parking space
