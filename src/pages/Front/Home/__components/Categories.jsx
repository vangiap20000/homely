...
import { categories as dataCategories } from "../../../../constants/const";
      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0 relative z-10">
        <div className="grid grid-cols-12 items-center gap-5 md:gap-10">
          <div className="lg:col-span-6 col-span-12">
            ...
            <Link to="/properties" className="py-4 px-8 bg-primary text-base leading-4 block w-fit text-white rounded-full font-semibold mt-8 hover:bg-dark duration-300">
              View properties
            </Link>
          </div>
